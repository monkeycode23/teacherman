    ...
    .withMessage("El nombre debe tener al menos 200 caracteres"),
      ...
      body("type")
        ...
        ,
         ...
         body("classroom")
        .notEmpty()
        .withMessage("El aula  es obligatorio")
        .isMongoId()
        ...
        /* .custom(async (value: string) => {
         ...
         body("timeStart")
        .notEmpty()
        .withMessage("La hora de incio  es obligatorio")
      ...
      ,
       ...
       /*   .custom((value, { req }) => {
    const dateStart = req.body.timeStart;
    const date = new Date(req.body.date);
    if (!dateStart) return true; // lo valida otro rule
