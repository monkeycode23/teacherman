...
type TabType = 'information' | 'stats' |'activities' | 'exams' | 'configs';

export function StudentSidePanel({student,onClose}:any) {
 ...
 //////////gettttt student info
  ...
  <div className="w-[800px] sm:w-[480px] md:w-[600px] lg:w-[800px] bg-white h-full shadow-xl flex flex-col animate-slide-in">
        ...
        <div className="p-6 border-b border-gray-200 flex items-start justify-between">
          <div>
            <h2 className="text-gray-900 mb-1 font-bold text-lg">{student.title}</h2>
        ...
        <div className="flex-1 overflow-y-auto p-6">
          {/* Resources Tab */}
          {activeTab === 'information' && (
              <InformacionTab selectedStudent={student}></InformacionTab>
          )}
